...
export function HourlyTemperature({ data }: HourlyTemperatureProps) {
  ...
  const chartData: ChartData[] = data.list
    ...
    .map((item) => ({
      ...
      //h is hour in 12-hour format, a is am/pm
        ...
        <div className="h-[200px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData}>
              ...
              />
              {/* tooltip for point moving on the chart to get exact value of temperature*/}
              {/* payload is array of objects that contains the data for the tooltip */}
              <Tooltip
